...
function Card({ id, title, img, bgColor, service_detail }) {
    ...
    return (
        <div className="relative flex m flex-col justify-center overflow-hidden bg-orange-200 py-6 sm:py-12">
            <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                <span className="absolute top-10 z-0 h-20 w-20 rounded-full transition-all duration-300 group-hover:scale-[10]" style={{ backgroundColor: bgColor }}></span>
                <div className="relative z-10 mx-auto max-w-md">
                    ...
                    <div className="pt-5 text-base font-semibold leading-7">
                        <p>
                            <a href="#" className="text-amber-500 transition-all duration-300 group-hover:text-white/90">{title}
                            </a>
                        </p>
                    </div>
                    <div
