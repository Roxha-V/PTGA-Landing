...
const cardData = [
    {
        id: 0, title: "Instalaciones", icon: "", img: "", bgColor: "#FEA700", service_detail:
            "Instalación y mantenimiento de:-Torres de telecomunicaciones. -Equipos y enlaces en altura. -Equipos de estudio. -Transmisores", link: ""
    },
    ...
    //     }, link: ""
    // },
    { id: 1, title: "Desmonte", icon: "", img: "", bgColor: "#2A00BF", service_detail: "El trabajo profesional de nuestras cuadrillas de técnicos, con capacitación en seguridad laboral para el trabajo en altura, resuelven situaciones de potencial peligro para un inmueble.", link: "?" },
    { id: 2, title: "Mantenimiento de plantas trasmisoras FM", icon: "", img: "", bgColor: "#A30DFC", service_detail: "Nuestros técnicos realizan las tareas de mantenimiento de punta a punta: desde los equipos del estudio hasta la baliza de la torre, garantizando el buen funcionamiento de tu planta transmisora, realizando tareas como:  Cambio de antenas y enlaces. Mantenimiento de torres. Asesoría para la compra equipos de estudio y planta transmisora.    ", link: "?" },
...
function ServiceSection(params) {
    ...
    return (
        <div id="services">
            <div>
                <div className="relative flex justify-center overflow-hidden bg-gray-100 p-6 sm:py-12 
