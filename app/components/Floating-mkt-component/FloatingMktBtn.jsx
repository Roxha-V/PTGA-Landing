function FloatingMktBtn() {
  const marketPlace = process.env.NEXT_PUBLIC_go_to_external; //env variable de tienda ml
  return (
    marketPlace && (
      <div>
        <a href={marketPlace} target="_blank">
          <svg
            className="w-14 h-14 md:w-20 md:h-20 fixed bottom-24 right-4 z-10 shadow-inner drop-shadow-md hover:drop-shadow-2xl"
            fill="#ffffff"
            height="500px"
            width="500px"
            viewBox="-220 -100 900 900"
            stroke="#636363"
          >
            <g
              id="SVGRepo_bgCarrier"
              strokeWidth="0"
              transform="translate(63.96858,63.96858) scale(1)"
            >
              <rect
                x="-160"
                y="-150"
