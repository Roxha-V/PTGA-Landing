    ...
    return (
        <div>
            <a href="whatsapp://send?phone=0000000000">
                <svg viewBox="0 0 32 32" className="ws-icon sm:w-12 sm:h-12 md:w-16 md:h-16 w-16 h-16 p-2 bg-green-600 fill-white rounded-full fixed bottom-4 right-4 z-10 shadow-md hover:drop-shadow-2xl">
