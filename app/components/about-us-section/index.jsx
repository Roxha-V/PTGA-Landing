...
function AboutUs() {
  const sectionStyle = {
    backgroundImage: "linear-gradient(-45deg,#120320,#43005F, #5C0092)",
  };
    ...
    <>
      <div id="about-us-section">
        <div className="w-full p-4 bg-gray-100">
          <div
            style={sectionStyle}
            className="w-full shadow-xl py-10 px-5 rounded-md ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl mx-auto"
          >
            <style>{`
          @keyframes gradient {
            0% {
