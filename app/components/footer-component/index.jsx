...
function Footer() {
  return (
    <footer
      id="footer-section"
      className="w-full h-1/2 p-10 bg-gradient-to-b from-gray-700 via-gray-400 to-gray-100 text-neutral-content spa"
    >
      <div className="flex flex-col lg:flex-row lg:justify-evenly items-center justify-center align-middle mb-5 text-2xl font-semibold text-gray-900">
        <div className="block text-sm text-center text-gray-500">
          <div className="text-center pb-12">
            <h6 className="footer-title text-white p-4 py-6 drop-shadow-sm">
              Contactanos
            </h6>
